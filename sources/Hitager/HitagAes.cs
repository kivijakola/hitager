...
namespace Hitager
{
    public partial class HitagAes : UserControl
    {
        ...
        private void WriteConfig_Click(object sender, EventArgs e)
        {
            ...
            String configMode = portHandler.portWR("i05e8");
        ...
        private void SegmentConfig_TextChanged(object sender, EventArgs e)
        {
            if(SegmentConfig.Text.Length == 4 )
            {
                try
                {
                    int.Parse(SegmentConfig.Text);
                    WriteConfigLSB.Enabled = true;
                    WriteConfig.Enabled = true;
                }
                catch(Exception ee)
